...
# Welcome message
echo -e "${GREEN}Welcome to the PeDitXrt Installer for OpenWrt!${NC}\n"
sleep 2

# Display the menu using whiptail (available in OpenWrt)
CHOICE=$(whiptail --title "PeDitXrt Installer" --menu "Please select the OS you want to install:" 15 60 6 \
"1" "OpenWRT" \
"2" "ImmortalWRT" \
"3" "PeDitXrt" \
"4" "Custom OS" \
