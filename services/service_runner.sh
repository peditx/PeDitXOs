...
# --- Dynamic URLs Start ---
# This section is auto-generated by the updater. DO NOT EDIT.
...
install_sshplus() {
    ...
    cd /tmp && rm -f install_sshplus.sh && wget -q "$URL_SSHPLUS" -O install_sshplus.sh && sh install_sshplus.sh
}

install_aircast() {
    echo "Downloading Air-Cast components..."
    cd /tmp && rm -f aircast_install.sh && wget -q "$URL_AIRCAST" -O aircast_install.sh && sh aircast_install.sh
}
